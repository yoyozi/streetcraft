...
const CredentialsSignInForm = ({ callbackUrl }: { callbackUrl: string }) => {
    ...
    console.log("[SIGNIN/SIGNINFORM] callbackUrl ------ ", callbackUrl);
    ...
    // Other way to get callbackUrl -Can be done using useSearchParams but this is working
    // const searchParams = useSearchParams();
    // const callbackURL = searchParams.get('callbackurl') || '/';
    // we pass this callback as a hidden input in the form below
